...
#undef tolower
#undef toupper
#define util_in_range(c, lo, up)  ((unsigned char)(c) >= (lo) && (unsigned char)(c) <= (up))
#define isdigit(c)           util_in_range((unsigned char)(c), '0', '9')
#define isxdigit(c)          (isdigit(c) || util_in_range((c), 'a', 'f') || util_in_range((c), 'A', 'F'))
#define islower(c)           util_in_range((c), 'a', 'z')
#define isspace(c)           ((c) == ' ' || (c) == '\f' || (c) == '\n' || (c) == '\r' || (c) == '\t' || (c) == '\v')
#define isupper(c)           util_in_range((c), 'A', 'Z')
