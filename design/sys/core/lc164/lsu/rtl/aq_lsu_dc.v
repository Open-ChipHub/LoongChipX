...
assign ag_ptw_inst_split                = mcic_dc_req ? 1'b0 : ag_dc_split;
...
begin
  if (ag_dc_create_vld | ifu_lsu_warm_up) begin
    ...
    dc_inst_split             <= ag_ptw_inst_split;
...
assign dc_lfb_inst_split     = dc_inst_split;
...
assign amo_inst_split            = lfb_data_sel ? lfb_dc_inst_split                : dc_inst_split;
...
assign dc_da_amo_inst_split    = amo_inst_split;
...
begin
  if (dc_da_data_vld_dp | ifu_lsu_warm_up) begin
    ...
    da_amo_inst_split  <= dc_da_amo_inst_split;
...
assign lsu_rtu_cmplt_split      = da_inst_vld & !da_vfls & !da_expt_vld & da_amo_inst_split;
